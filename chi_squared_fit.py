...
w = df["starts"].to_numpy(dtype=float)  # weights = starts (bigger group = more reliable)
...
# (matches the Week 9 “chi2 per degree of freedom” idea, without GLM)
